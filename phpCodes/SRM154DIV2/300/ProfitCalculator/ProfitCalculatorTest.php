...
require_once 'ProfitCalculator.php';

$pc = new ProfitCalculator();

$items = array("012.99 008.73","099.99 050.00","123.45 101.07");
$margin = $pc->percent($items);

echo "\nItems " ; print_r($items);
echo "\nmargin: $margin";

$items = array("000.00 049.99","999.99 936.22","033.99 025.64","249.99 211.87"); 
$margin = $pc->percent($items);
...
$items = array("822.77 704.86","829.42 355.45","887.18 949.38"); 
$margin = $pc->percent($items);
...
$items = array("612.72 941.34","576.46 182.66","787.41 524.70","637.96 333.23","345.01 219.69", "567.22 104.77","673.02 885.77");
$margin = $pc->percent($items);
...
$items = array("811.22 275.32","433.89 006.48","141.28 967.41","344.47 786.23","897.47 860.61",
